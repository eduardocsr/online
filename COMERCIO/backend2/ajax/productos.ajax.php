...
class AjaxProductos{
	...
	public function  ajaxCrearProducto(){
		...
		$datos = array(
			...
			"fotoPrincipal2"=>$this->fotoPrincipal2,
	...
	public function  ajaxEditarProducto(){
		...
		$datos = array(
			...
			"antiguaFotoPrincipal"=>$this->antiguaFotoPrincipal,
				"antiguaFotoPrincipal2"=>$this->antiguaFotoPrincipal2,
...
if(isset($_POST["tituloProducto"])){
	...
	if(isset($_FILES["fotoPrincipal2"])){

		$producto -> fotoPrincipal2 = $_FILES["fotoPrincipal2"];

	}else{

		$producto -> fotoPrincipal2 = null;
...
if(isset($_POST["id"])){
	...
	if(isset($_FILES["fotoPrincipal2"])){
				...
				$editarProducto -> fotoPrincipal2 = $_FILES["fotoPrincipal2"];

	}else{

			$editarProducto -> fotoPrincipal2 = null;
	...
	$editarProducto -> antiguaFotoPrincipal2 = $_POST["antiguaFotoPrincipal2"];

...
class TablaProductos{
  ...
  public function mostrarTablaProductos(){	
  	...
  	$datosJson = '
        ...
        $imagenPrincipal2 = "<img src='".$productos[$i]["portada2"]."' class='img-thumbnail imgTablaPrincipal' width='100px'>";
			...
			if($productos[$i]["oferta"] != 0){
  			...
  			$acciones = "<div class='btn-group'><button class='btn btn-warning btnEditarProducto' idProducto='".$productos[$i]["id"]."' data-toggle='modal' data-target='#modalEditarProducto'><i class='fa fa-pencil'></i></button><button class='btn btn-danger btnEliminarProducto' idProducto='".$productos[$i]["id"]."' imgOferta='".$productos[$i]["imgOferta"]."' rutaCabecera='".$productos[$i]["ruta"]."' imgPortada='".$cabeceras["portada"]."' imgPrincipal='".$productos[$i]["portada"]."' imgPrincipal2='".$productos[$i]["portada2"]."'><i class='fa fa-times'></i></button></div>";

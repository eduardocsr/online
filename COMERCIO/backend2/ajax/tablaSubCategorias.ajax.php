...
class TablaSubCategorias{
  ...
  public function mostrarTablaSubCategoria(){	
	...
	if($subcategorias[$i]["subimg"] != ""){

	  			$subimg = "<img src='".$subcategorias[$i]["subimg"]."' class='img-thumbnail imgTablaSubCategorias' width='100px'>";

	  		}else{

	  			$subimg = "<img src='vistas/img/menu/default/default.jpg' class='img-thumbnail imgTablaSubCategorias' width='100px'>";

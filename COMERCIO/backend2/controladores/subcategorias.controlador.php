...
/*=============================================
				...
				if(isset($_FILES["fotoMenu"]["tmp_name"]) && !empty($_FILES["fotoMenu"]["tmp_name"])){

					/*=============================================
					DEFINIMOS LAS MEDIDAS
					=============================================*/

					list($ancho, $alto) = getimagesize($_FILES["fotoMenu"]["tmp_name"]);
					...
					if($_FILES["fotoMenu"]["type"] == "image/jpeg"){
						...
						$rutaMenu = "vistas/img/menu/".$_POST["rutaSubCategoria"].".jpg";

						$origen = imagecreatefromjpeg($_FILES["fotoMenu"]["tmp_name"]);						
						$destino = imagecreatetruecolor($nuevoAncho, $nuevoAlto);

						imagecopyresized($destino, $origen, 0, 0, 0, 0, $nuevoAncho, $nuevoAlto, $ancho, $alto);

						imagejpeg($destino, $rutaMenu);

					}

					if($_FILES["fotoMenu"]["type"] == "image/png"){
						...
						$rutaMenu = "vistas/img/menu/".$_POST["rutaSubCategoria"].".png";

						$origen = imagecreatefrompng($_FILES["fotoMenu"]["tmp_name"]);						
						$destino = imagecreatetruecolor($nuevoAncho, $nuevoAlto);
...
/*=============================================
				...
				$rutaMenu = $_POST["antiguaFotoMenu"];

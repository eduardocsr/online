...
<div class="box box-solid ">
	...
	<div class="box-header with-border">
	    ...
	    <h3 class="box-title text-info">Ventas por mes y año</h3>
  	...
  	<div class="box-footer no-border">
	    ...
	    <div class="row">
	      ...
	      <div class="col-xs-6 text-center" style="border-right: 1px solid #f4f4f4">
	        ...
	        <input type="text" class="knob" data-readonly="true" value="<?php echo round($porcentajePaypal); ?>" data-width="60" data-height="60" data-fgColor="#3c8dbc">

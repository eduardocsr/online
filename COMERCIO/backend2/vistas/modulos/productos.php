          ...
          <div class="box-body">
           ...
           <!--=====================================
            ...
            <div class="form-group">
              ...
              <!--=====================================
            AGREGAR FOTO DE MULTIMEDIA 2
            ======================================-->

            <div class="form-group">
                
              <div class="panel">SUBIR FOTO PRINCIPAL DEL PRODUCTO 2</div>

              <input type="file" class="fotoPrincipal2">

              <p class="help-block">Tamaño recomendado 400px * 450px <br> Peso máximo de la foto 2MB</p>

              <img src="vistas/img/Portada2/default/default.jpg" class="img-thumbnail previsualizarPrincipal2" width="200px">
          ...
          <div class="box-body">
           ...
           <!--=====================================
            ...
            <div class="form-group">
              ...
              <input type="file" class="fotoPrincipal2">
              <input type="hidden" class="antiguaFotoPrincipal2">

<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-footer text-center">Empresa emprendedora textil Marca Bangui</div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="modal-header" style="background: linear-gradient(135deg, rgba(183,222,237,1) 0%, rgba(113,206,239,1) 50%, rgba(33,180,226,1) 51%, rgba(183,222,237,1) 100%);; color:white">
          
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          
         <center><h3 class="modal-title">Editar categoría</h3></center> 

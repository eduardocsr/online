        ...
        <div class="modal-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="panel">SUBIR FOTO DE MENU</div>

              <input type="file" class="fotoMenu" name="fotoMenu">

              <p class="help-block">Tamaño recomendado 1280px * 720px <br> Peso máximo de la foto 2MB</p>

              <img src="vistas/img/menu/default/default.jpg" class="img-thumbnail previsualizarMenu" width="50%">
...
<div id="modalEditarSubCategoria" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
   ...
   <!--=====================================
            ENTRADA PARA EDITAR LA FOTO DE MENU
            ======================================-->

            <div class="form-group">
              
              <div class="panel">SUBIR FOTO MENU</div>

              <input type="file" class="fotoMenu" name="fotoMenu">
              <input type="hidden" class="antiguaFotoMenu" name="antiguaFotoMenu">

...
$(".agregarSlide").click(function(){
	...
	var imgFondo = "vistas/img/slide/default/back_default.jpg";
...
$(".subirFondo").change(function(){
	...
	if(imagenFondo["type"] != "image/jpeg" && imagenFondo["type"] != "image/png"  && imagenFondo["type"] != "image/gif"){
	...
	}else if(imagenFondo["size"] > 4000000){
   ...
   // CAPTURAMOS EL TÍTULO 2
	...
	$.ajax({
		...
		success: function(respuesta){
				...
				toastr.success("Slider guardado correctamente");	

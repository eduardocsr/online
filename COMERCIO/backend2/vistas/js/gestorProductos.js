...
$(".fotoPrincipal").change(function(){
	...
	/*=============================================
  	...
  	if(imagenFotoPrincipal["type"] != "image/jpeg" && imagenFotoPrincipal["type"] != "image/png" && imagenFotoPrincipal["type"] != "image/gif"){
...
/*=============================================
SUBIENDO LA FOTO PRINCIPAL DOS
=============================================*/

var imagenFotoPrincipal2 = null;

$(".fotoPrincipal2").change(function(){

	imagenFotoPrincipal2 = this.files[0];
	
	/*=============================================
  	VALIDAMOS EL FORMATO DE LA IMAGEN SEA JPG O PNG
  	=============================================*/

  	if(imagenFotoPrincipal2["type"] != "image/jpeg" && imagenFotoPrincipal2["type"] != "image/png"){
  	...
  	}else if(imagenFotoPrincipal2["size"] > 2000000){
  		...
  		var datosImagen = new FileReader;
  		datosImagen.readAsDataURL(imagenFotoPrincipal2);

  		$(datosImagen).on("load", function(event){

  			var rutaImagen = event.target.result;

  			$(".previsualizarPrincipal2").attr("src", rutaImagen);
...
function agregarMiProducto(imagen){
		...
		datosProducto.append("fotoPrincipal", imagenFotoPrincipal);
			datosProducto.append("fotoPrincipal2", imagenFotoPrincipal2);
...
$('.tablaProductos tbody').on("click", ".btnEditarProducto", function(){
	...
	$.ajax({
		...
		success: function(respuesta){
			...
			$("#modalEditarProducto .previsualizarPrincipal2").attr("src", respuesta[0]["portada2"]);
			$("#modalEditarProducto .antiguaFotoPrincipal2").val(respuesta[0]["portada2"]);
...
function editarMiProducto(imagen){
	...
	var antiguaFotoPrincipal = $("#modalEditarProducto .antiguaFotoPrincipal").val();
		var antiguaFotoPrincipal2 = $("#modalEditarProducto .antiguaFotoPrincipal2").val();
	...
	datosProducto.append("antiguaFotoPrincipal2", antiguaFotoPrincipal2);
...
var imgPrincipal2 = $(this).attr("imgPrincipal2");
  swal({
    ...
    if(result.value){
      ...
      window.location = "index.php?ruta=productos&idProducto="+idProducto+"&imgOferta="+imgOferta
      +"&rutaCabecera="+rutaCabecera+"&imgPortada="+imgPortada+"&imgPrincipal="+imgPrincipal+"&imgPrincipal2="+imgPrincipal2;

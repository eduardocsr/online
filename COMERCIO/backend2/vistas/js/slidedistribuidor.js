		...
		$.ajax({
			...
			success: function(respuesta){
				...
				if (respuesta == 0) {
					...
					$("#columnasSlide").before('<div class="alert alert-warning alerta text-center">La imagen es inferior a 1600px * 300px</div>')

				}else{
console.log("respuesta", respuesta);
					$("#columnasSlide").css({"height":"auto"});

					$("#columnasSlide").append('<li class="bloqueSlide"><span class="fa fa-times eliminarSlide2"></span><img src="'+respuesta["ruta"].slice(3)+'" class="handleImg"></li>');

					$("#ordenarTextSlide").append('<li><span class="fa fa-pencil" style="background:blue"></span><img src="'+respuesta["ruta"].slice(3)+'" style="float:left; margin-bottom:10px" width="80%"><h1>'+respuesta["titulo"]+'</h1><p>'+respuesta["descripcion"]+'</p></li>');
						...
						swal({
						  ...
						  confirmButtonText: "Cerrar"
							...
							window.location = "slidedistribuidor";
...
$(".eliminarSlide2").click(function(){

	if($(".eliminarSlide2").length == 1){
	...
	$.ajax({
		...
		processData: false,
		success: function(respuesta){
       toastr.success("Slider eliminado correctamente");	
		}
	...
	$("#guardar"+idSlide).click(function(){
		...
		$.ajax({
			...
			success: function(respuesta){
				...
				swal({ 
						  type: "success",
						  title: "El slide ha sido editado correctamente",
						  showConfirmButton: true,
						  confirmButtonText: "Cerrar"
						  }).then(function(result){
							if (result.value) {

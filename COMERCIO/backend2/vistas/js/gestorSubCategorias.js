...
/*=============================================
SUBIENDO LA FOTO DE LA menu
=============================================*/

$(".fotoMenu").change(function(){
	...
	/*=============================================
  	...
  	if(imagen["type"] != "image/jpeg" && imagen["type"] != "image/png"){
  		...
  		$(datosImagen).on("load", function(event){
  			...
  			$(".previsualizarMenu").attr("src", rutaImagen);
...
$(".tablaSubCategorias tbody").on("click", ".btnEditarSubCategoria", function(){
	...
	$("#modalEditarSubCategoria .previsualizarMenu").attr("src", respuesta[0]["subimg"]);
						$("#modalEditarSubCategoria .antiguaFotoMenu").val(respuesta[0]["subimg"]);

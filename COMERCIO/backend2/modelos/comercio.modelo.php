...
class ModeloComercio{
	...
	static public function mdlActualizarScript($tabla, $id, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET chatEnLinea=:chatEnLinea, apiFacebook = :apiFacebook, pixelFacebook = :pixelFacebook, googleAnalytics = :googleAnalytics WHERE id = :id");
         $stmt->bindParam(":chatEnLinea", $datos["chatEnLinea"], PDO::PARAM_STR);

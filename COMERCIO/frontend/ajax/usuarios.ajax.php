...
public function ajaxAgregarDeseo(){
    ...
    # Realizamos la consulta para saber si estaba en los deseos anteriores
    $consulta=ControladorUsuarios::ctrConsultarDeseo($datos);
    if(count($consulta["id_producto"])!=1){
        $respuesta = ControladorUsuarios::ctrAgregarDeseo($datos);
        echo $respuesta;}
}
*/

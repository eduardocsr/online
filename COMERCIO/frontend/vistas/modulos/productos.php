			                ...
			                <div class="product-image">
										...
										$fechaNueva = date('Y-m-d', $fechaActual);
						                    ...
						                    <ul class="social">
						                        ...
						                        <li><a href="'.$value["ruta"].'" class="pixelProducto" data-tip="Ver Producto"><i class="fa fa-search"></i></a></li>
								...
								if ($value["precio"]==0) {
									...
									echo '<h2>
											...
											<small >
                                               ...
                                               <strong  style=" border:2px #D8D8D8 solid;left: auto;right: 12px;border-radius: 10px; padding: 0 7px;" class="oferta">PEN S/$'.round($value["precio"]/$soles).'</strong> 
											</small>

											<small style="display:none">$'.$value["precioOferta"].'</small>
										    

										    <small style=" border:2px #D8D8D8 solid;left: auto;right: 12px;border-radius: 10px; padding: 0 7px;" >S/'.round($value["precioOferta"]/$soles).'</small>
										
										</h2>';
									}else{
                                     echo'<h2>

                                          <small style="display:none">$'.$value["precio"].'</small>
                                          <small style=" border:2px #D8D8D8 solid;left: auto;right: 12px;border-radius: 10px; padding: 0 7px;">$'.round($value["precio"]/$soles).'</small>
						...
						<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
							...
							if ($value["precio"]==0) {
									...
									if ($value["oferta"] !=0 ) {
                                     ...
                                     <small style="display:none">USD $'.$value["precio"].'</small>

                                      <small style=" border:2px #D8D8D8 solid;left: auto;right: 12px;border-radius: 10px; padding: 0 7px;">PEN S/'.round($value["precio"]/$soles).'</small>

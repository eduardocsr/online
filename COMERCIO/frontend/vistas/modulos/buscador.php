...
/*--=====================================
	LLAMADA DE PRODUCTOS POR BUSQUEDA
	======================================*/
	$productos=null;
	...
	if (isset($rutas[3])) {
		...
		$productos= ControladorProductos:: ctrBuscarProductos($busqueda, $ordenar, $modo, $base, $tope);
         $listarProductos=ControladorProductos::ctrListarProductosBusqueda($busqueda);
	}
									 ...
									 <a href="'.$value["ruta"].'" class="pixelProducto">
										...
										$fechaNueva = date('Y-m-d', $fechaActual);
						                    ...
						                    <ul class="social">
						                        ...
						                        <li><a href="'.$url.$value["ruta"].'" class="pixelProducto" data-tip="Ver Producto"><i class="fa fa-search"></i></a></li>

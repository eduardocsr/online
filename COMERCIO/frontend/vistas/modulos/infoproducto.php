				...
				<?php
					...
					echo '<div class="comprarAhora" style="display:none">
						...
						if($infoproducto["oferta"] == 0){
							...
							<p class="subTotal'.$infoproducto["id"].' subtotales">
								...
								<strong>PEN S/<span>'.round($infoproducto["precio"]/$soles).'</span></strong>
					...
					if($infoproducto["precio"] == 0){
						...
						if($infoproducto["oferta"] == 0){
							...
							echo '<h2 style="display:none;" class="text-muted">USD $'.$infoproducto["precio"].'</h2>
                                 <h2 class="text-muted">PEN S/'.round($infoproducto["precio"]/$soles).'</h2>
							...
							echo '<h2 class="text-muted">
								...
								<span>
									...
									<strong style="display:none;" class="oferta">USD $'.$infoproducto["precio"].'</strong>
                                    <strong class="oferta">PEN S/'.round($infoproducto["precio"]/$soles).'</strong>
								</span>

								<span>
									
									<h1 style="display:none;">$'.$infoproducto["precioOferta"].'</h1> 
                                   	S/'.round($infoproducto["precioOferta"]/$soles).'
								</span>
						...
						if($infoproducto["tipo"] == "fisico"){
							...
							if($detalles["Talla"]!=null){
								...
								echo '<div class="col-md-3 col-xs-12">
									...
									<select style="background:#BCCCCD" class="form-control seleccionarDetalle" id="seleccionarTalla">
							...
							if($detalles["Color"]!=null){
								...
								echo '<div class="col-md-3 col-xs-12">
									...
									<select style="background:#BCCCCD" class="form-control seleccionarDetalle" id="seleccionarColor">
							...
							if($detalles["Marca"]!=null){
								...
								echo '<div class=" col-md-3 col-xs-12">
									...
									<select style="background:#BCCCCD" class="  form-control seleccionarDetalle" id="seleccionarMarca">
							...
							if($value["oferta"] != 0){
								...
								echo '<h2>
										...
										<small>
											...
											<strong style="display:none;" class="oferta">USD $'.$value["precio"].'</strong>
                                            <strong class="oferta">PEN S/'.round($value["precio"]/$soles).'</strong>
										</small>

										<small style="display:none;">$'.$value["precioOferta"].'</small>
									<small>$'.round($value["precioOferta"]/$soles).'</small>
									</h2>';

							}else{

								echo '<h2 style="display:none;"><small>USD $'.$value["precio"].'</small></h2>

                                      <h2><small>PEN  S/'.round($value["precio"]/$soles).'</small></h2>

...
<img class="img-thumbnail" src="'.$servidor.$value2["portada"].' ">
					                ...
					                <div class="col-sm-6 col-xs-12">
                                     ...
                                     if ($value2["tipo"]=="virtual") {
                                     	...
                                     	echo'<h6>Procesos de entrega:'.$value2["entrega"].'días hábiles</h6>';
                                     		if($value1["envio"] == 0){
					             ...
					             echo '<h4 class="pull-right"><small>Comprado el '.($value1["fecha"]).'</small></h4>
                                 <h4></h4>
					             ...
					             $datos=array("idUsuario"=>$_SESSION["id"],"idProducto"=>$value2["id"]);
					...
					<form method="post" enctype="multipart/form-data">
						...
						if($_SESSION["modo"] != "directo"){
							...
							echo '<label class="control-label text-muted text-uppercase" for="editarNombre">Cambiar Nombre:</label>
									...
									<div class="input-group perfil2">
								
										<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
										<input type="text" class="form-control" id="editarNombre" name="editarNombre" value="'.$_SESSION["nombre"].'" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ]+">
								...
								<div class="input-group">
										...
										<input type="password" class="form-control" id="editarPassword" name="editarPassword" placeholder="Escribe la nueva contraseña" pattern="[A-Za-z0-9]+">

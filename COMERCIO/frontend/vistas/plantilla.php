...
<head>
	...
	<?php
		...
		$plantilla = ControladorPlantilla::ctrEstiloPlantilla();
			$fotos = ControladorPlantilla::ctrfotos();
...
<!--<link rel="stylesheet" href="<?php echo $url; ?>vistas/css/plugins/toastr.css">-->
<link rel="stylesheet" href="<?php echo $url; ?>vistas/css/plugins/dscountdown.css">
   ...
   <link rel="stylesheet" href="<?php echo $url; ?>vistas/css/infoproducto.css">
     <link rel="stylesheet" href="<?php echo $url; ?>vistas/css/perfil.css">
     	...
     	<link rel="stylesheet" href="<?php echo $url; ?>vistas/css/Prueba.css">
     	 	<link rel="stylesheet" href="<?php echo $url; ?>vistas/css/sliderproductos.css">
     	 	<link rel="stylesheet" href="<?php echo $url; ?>vistas/css/ofertas.css">
     	 	<link rel="stylesheet" href="<?php echo $url; ?>vistas/css/slidedistribuidor.css">
...
<script src="<?php echo $url; ?>vistas/js/plugins/jquery.flexisel.js"></script>
<!--<script src="<?php echo $url; ?>vistas/js/prueba.js"></script>-->
...
<script src="<?php echo $url; ?>vistas/js/plugins/jquery.scrollUp.min.js"></script>
<script src="<?php echo $url; ?>vistas/js/plugins/dscountdown.min.js"></script>

	<script src="https://apis.google.com/js/platform.js" async defer></script>
<!--<script src="<?php  $url; ?>vistas/js/plugins/toastr.js"></script>-->
...
if(isset($_GET["ruta"])){
    ...
    else if($rutas[0] == "buscador"||$rutas[0]=="verificar"||$rutas[0]=="salir" ||$rutas[0]=="perfil"  ||$rutas[0]=="carrito-de-compras"  ||$rutas[0]=="error"   ||$rutas[0]=="finalizar-compra" ||$rutas[0]=="curso" ||$rutas[0]=="ofertas"   ||$rutas[0]=="comprobante"){
...
<script src="<?php echo $url; ?>vistas/js/carritomenu.js"></script>
<script src="<?php echo $url; ?>vistas/js/slidedistribuidor.js"></script>
...
<script type="text/javascript">
    (function () {
        window.siqConfig = {
            engineKey: "c859a429e13bae55575557bdb3c707e2",
...
const edu = document.querySelector('.edudiv');
console.log(edu);

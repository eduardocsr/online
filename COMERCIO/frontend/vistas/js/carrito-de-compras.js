...
$(".agregarCarrito").click(function(){
	...
	if(agregarAlCarrito){
		...
		if(localStorage.getItem("listarProductos") == null){
			...
			var listarProductos = JSON.parse(localStorage.getItem("listarProductos"));

			for(var i = 0; i < listarProductos.length; i++){

				if(listarProductos[i]["idProducto"] == idProducto && listarProductos[i]["tipo"] == "virtual"){
			...
			listaCarrito.concat(localStorage.getItem("listarProductos"));
		...
		localStorage.setItem("listarProductos", JSON.stringify(listaCarrito));
...
$(document).on("click", ".quitarItemCarrito", function(){
	...
	if(idProducto.length != 0){
		...
		localStorage.removeItem("listarProductos");

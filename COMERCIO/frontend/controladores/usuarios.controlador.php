			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				if($respuesta == "ok"){
					...
					$mail->setFrom('ruieducassal@gmail.com', 'Empresa bangui');

					$mail->addReplyTo('ruieducassal@gmail.com', 'Empresa bangui');
				...
				=============================================*/
					...
					$mail->msgHTML('
						...
						<div style="position:relative; margin:auto; width:600px; background:white; padding-bottom:20px">
							...
							<img style="padding-top:20px; width:15%" src="http://www.CASTILLO.com/tienda/icon-email.png">
